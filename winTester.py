import Baroque_Chess_state_etc as Baroque_Chesss
...
def winTester(s):
  ...
  for i in range(8):
    for j in range(8):
      if b[i][j] == Baroque_Chesss.BLACK_KING: black_king_detected = True
      if b[i][j] == Baroque_Chesss.WHITE_KING: white_king_detected = True
