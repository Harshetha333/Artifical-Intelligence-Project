...
We use 2 alternative representations of states:
 ...
 R2. A class Baroque_Chess_state that contains a representation of the
     board consisting of an array (implemented as alist of lists).

 To go from R1 to R2, use function: parse to get a board array,
    and then we construct an instance of Baroque_Chess_state.
...
def test_starting_board():
  init_state = Baroque_Chess_state(INITIAL, WHITE)
  print(init_state)
